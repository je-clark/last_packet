...
def last_timestamp(infile): # Expecting most of this to be command line input, so strings
    ...
    timestamp = iterate(in_ptr, endianness)
    ...
    #print(f"Last packet's timestamp is {datetime.fromtimestamp(timestamp)}")
    in_ptr.close()
...
if __name__ == "__main__":
	...
	print(f"Last packet's timestamp is {datetime.fromtimestamp(last_timestamp(a.infile))}")